...
//Getting Connection using MS Access
	...
	public static Connection getConnection() throws Exception {
		...
		try {
			...
			dbConn = DriverManager.getConnection(url, "root", "sqlsun1ta");
...
// EMailAddress Queries
	...
	public EMailAddressVOO getEMailAddress(String inEMailID) throws Exception {
	...
	public void addEMailAddress(EMailAddressVOO inEMailAddress) throws Exception {
	...
	public void updateEMailAddress(EMailAddressVOO inEMailAddress) throws Exception {
		Connection dbConn = null;
		PreparedStatement pStmt = null;
		int rowsUpdated = 0;
		...
		try {
			...
			pStmt = dbConn.prepareStatement(
					"UPDATE emailaddress SET firstname = ?, middlename = ?, lastname = ?, workphoneno = ?, mobileno = ?, homephoneno = ?, groupid = ? Where emailaddress=?");
	...
	public void deleteEMailAddress(String inEMailID) throws Exception {
		Connection dbConn = null;
		PreparedStatement pStmt = null;
		int rowsDeleted = 0;
	...
	public ArrayList<EMailAddressVOO> getAllEMailAdressEntries() throws Exception {
	...
	public ArrayList<EMailAddressVOO> getAllEMailAdressEntriesbyGroup(String inGroupID) throws Exception {
		...
		try {
			dbConn = getConnection();
			System.out.println("inGroupID is: " + inGroupID);
...
// Group Queries
	...
	public Group getGroup(String inGroupID) throws Exception {
	...
	public void addGroup(Group inGroup) throws Exception {
		Connection dbConn = null;
		PreparedStatement pStmt = null;
		int rowsInserted = 0;
	...
	public void updateGroup(Group inGroup) throws Exception {
		Connection dbConn = null;
		PreparedStatement pStmt = null;
		int rowsUpdated = 0;
	...
	public void deleteGroup(String inGroupID) throws Exception {
		Connection dbConn = null;
		PreparedStatement pStmt = null;
		int rowsDeleted = 0;
	...
	public ArrayList getAllGroupEntries() throws Exception {
		Connection dbConn = null;
		PreparedStatement pStmt = null;
		ResultSet rs = null;
