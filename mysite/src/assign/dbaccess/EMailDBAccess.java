...
// EMailAddress Queries
	...
	public void addEMailAddress(EMailAddressVOO inEMailAddress) throws Exception {
		...
		try {
			dbConn = getConnection();
			pStmt = dbConn.prepareStatement("INSERT INTO emailaddress (?,?,?,?,?,?,?,?)");
	...
	public void updateEMailAddress(EMailAddressVOO inEMailAddress) throws Exception {
		...
		try {
			...
			pStmt = dbConn.prepareStatement(
					"UPDATE emailaddress SET emailadress = ?, firstname = ? middlename = ? lastname = ?, homephone = ?, workphone = ?, mobilephone = ?, groupid = ?");
			pStmt.setString(1, inEMailAddress.geteMailID());
			pStmt.setString(2, inEMailAddress.getfName());
			pStmt.setString(3, inEMailAddress.getmName());
			pStmt.setString(4, inEMailAddress.getlName());
	...
	public ArrayList getAllEMailAdressEntriesbyGroup(String inGroupID) throws Exception {
